...
const Hero = () => {
  const { user } = useContext(AuthContext); // ✅ ইউজার চেক করুন
    ...
    >
      ...
      <div className="relative w-11/12 mx-auto z-10">
        <div className="max-w-3xl">
          ...
          >
            <span className="text-white">Join Elite</span>
            <br />
            <span className="text-purple-400">Free Fire</span>
            <br />
          ...
          <motion.p
            ...
            className="mt-8 text-lg md:text-xl text-gray-300 leading-8 max-w-2xl"
          >
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-400">Custom Rooms</p>
            </div>
            <div>
